...
export const videoEditingSkills = [
  ...
  },
  {
    ...
    icon: Zap,
    description: "Fast-paced video editing, trendy effects, and social media optimization",
    color: "text-white",
  },
];
...
export const specializations = [
  ...
  },
  {
    ...
    icon: "🎯",
    description: "Crafting high-converting promotional videos that drive engagement",
  },
  {
    title: "Color Grading",
    skills: [
